...
---
Based on the update plan documented in "repo_update_plan.md" and the milestones under "/milestones/", start implementing the first milestone by following the tasks outlined in the milestone description. Document the implementation process in "changelog_milestone_#{NUMBER}.md" under "/docs/code_modernization/implementation/" folder within the repository, including:
