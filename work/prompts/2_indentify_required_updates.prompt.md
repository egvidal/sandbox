...
---
Based on "ansible-best-practices" and "naming-conventions" instructions files included in this workspace, analyze what changes should be made to the repo structure and each existing file. Document the analysis in "repo_required_updates.md" under Copilot working folder.
