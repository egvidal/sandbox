...
model: GPT-5.2
---
Based on the analysis documented in "Copilot_{REPO_SHORTNAME}/repo_analysis.md" and "Copilot_{REPO_SHORTNAME}/repo_required_updates.md", create a detailed plan for updating the repository applying Ansible standards and best practices in a controlled, milestone-based rollout that prioritizes:
...
Document the plan in "Copilot_{REPO_SHORTNAME}/repo_update_plan.md".