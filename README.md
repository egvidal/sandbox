...
- now generate one md file per milestone under "work/milestones/". Each file must include all details (for that milestone) extracted from "work/milestones.md" and also a comparison between the before and after of the changing code/files/structure. Make it accurate and professional, since this is to be shown to the SME/SRE/Architect.
